...
const Button = (props: ButtonProps) => {
  return (
    <button {...props}>
      <span className="relative inline-flex items-center justify-start px-6 py-2 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
